...
### Описание содержимого директорий (групп):
#### HW_DB_1:  
...
``  
##### 3.3. Выполните скрипт DB_N_Initialisation.sql (например, DB_1_Initialisation.sql) для создания и наполнения таблиц.  
...
Скрипты DB_N_Initialisation.sql содержат код для создания и наполнения таблиц, но не создают саму базу данных.  
